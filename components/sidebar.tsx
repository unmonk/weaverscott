...
const Sidebar = () => {
  return (
    <div className="drawer-side bg-base-200">
      <label htmlFor="my-drawer" className="drawer-overlay bg-base-200"></label>
      <div className="menu flex flex-col flex-nowrap p-4 overflow-y-auto w-[10rem] bg-base-200 text-base-content">
        <div className="w-fit">
          <a href="/">
        ...
        <div className="social-icons my-2 flex self-center">
          <a
          ...
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="bg-secondary rounded-lg hover:bg-accent fill: currentColor;transform: ;msFilter:;"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
